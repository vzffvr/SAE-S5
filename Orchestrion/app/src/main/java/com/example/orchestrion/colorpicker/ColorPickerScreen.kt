...
fun ColorPickerScreen() {
    ...
    ColorPickerScreen(myMQTT = myMQTT, viewModel = viewModel, navController = null)
}

@Composable
fun ColorPickerScreen(myMQTT: MqttClientManager, navController: NavController?, viewModel: ColorViewModel)
{
    BackHandler()
    {
    }
