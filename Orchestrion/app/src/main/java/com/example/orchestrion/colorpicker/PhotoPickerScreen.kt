...
import com.example.orchestrion.ZoneSelection
...
fun ImageColorPickerScreen() {
    ...
    ImgColorPickerScreen(myMQTT, viewModel, null)
}

@Composable
fun ImgColorPickerScreen(myMQTT: MqttClientManager, viewModel: ColorViewModel, navController: NavController?)
{

    BackHandler()
    {
        navController?.navigate(ZoneSelection)
    }
