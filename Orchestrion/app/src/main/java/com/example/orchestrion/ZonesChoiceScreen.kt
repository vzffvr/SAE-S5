...
fun ZoneChoseScreen() {
    ...
    ZoneSelectionScreen(navController = null, viewmodel = viewModel,myMQTT = myMQTT)
}

@Composable
fun ZoneSelectionScreen(navController: NavController?, viewmodel: ColorViewModel, myMQTT: MqttClientManager)
{
    BackHandler()
    {
