...
fun HomeMenuScreen() {
    ...
    MainSelectionScreen(navController = null, viewmodel = viewModel, myMQTT= myMQTT)
}

@Composable
fun MainSelectionScreen(navController: NavController?, viewmodel: ColorViewModel, myMQTT: MqttClientManager)
{
